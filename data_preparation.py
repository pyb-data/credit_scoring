...
def prepareData(train_or_test, data_size, only_default=False):
    ...
    if data_size == 's':
        ...
        dfApplication = pd.read_csv(os.getcwd() + '/Projet+Mise+en+prod+-+home-credit-default-risk-FULL/application_' + train_or_test + '.csv',",")
        dfBureau = pd.read_csv(os.getcwd() + '/Projet+Mise+en+prod+-+home-credit-default-risk-FULL/bureau.csv',",")  
        dfBureauBalance = pd.read_csv(os.getcwd() + '/Projet+Mise+en+prod+-+home-credit-default-risk-FULL/bureau_balance.csv',",")
        dfPreviousApplication = pd.read_csv(os.getcwd() + '/Projet+Mise+en+prod+-+home-credit-default-risk-FULL/previous_application.csv',",")
        dfPosCashBalance = pd.read_csv(os.getcwd() + '/Projet+Mise+en+prod+-+home-credit-default-risk-FULL/POS_CASH_balance.csv',",")
        dfCreditCardBalance = pd.read_csv(os.getcwd() + '/Projet+Mise+en+prod+-+home-credit-default-risk-FULL/credit_card_balance.csv',",")
        dfInstallmentsPayments = pd.read_csv(os.getcwd() + '/Projet+Mise+en+prod+-+home-credit-default-risk-FULL/installments_payments.csv',",")
